...
namespace modul13_2211104008
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine(" Nama : Maria Nathasya ");
            ...
            data1.AddSebuahData("Nama Anggota 1: Lintang");
            data1.AddSebuahData("Nama Anggota 2: Devrin");
            data1.AddSebuahData("Nama Anggota 3: Alfian");
